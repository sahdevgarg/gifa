...
! function(e, t) {
    ...
    var s = {},
        ...
        Se = "tinymce/FocusManager",
        ke = "tinymce/EditorManager",
    ...
    r(l, [], function() {
        ...
        var x, C, w, _, E, N, S, k, T, R, A, B, D, M, L, H, P, O, I, F = "sizzle" + -new Date,
            z = window.document,
            W = 0,
            V = 0,
            U = n(),
        ...
        C = e.support = {}, E = e.isXML = function(e) {
            ...
            var t, n = e ? e.ownerDocument || e : z,
                r = n.defaultView;
            return n !== D && 9 === n.nodeType && n.documentElement ? (D = n, M = n.documentElement, L = !E(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function() {
                B()
            ...
            })), (C.matchesSelector = ge.test(O = M.matches || M.webkitMatchesSelector || M.mozMatchesSelector || M.oMatchesSelector || M.msMatchesSelector)) && i(function(e) {
                C.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), P.push("!=", ae)
            }), H = H.length && new RegExp(H.join("|")), P = P.length && new RegExp(P.join("|")), t = ge.test(M.compareDocumentPosition), I = t || ge.test(M.contains) ? function(e, t) {
            ...
            if ((t.ownerDocument || t) !== D && B(t), n = n.replace(ue, "='$1']"), C.matchesSelector && L && (!P || !P.test(n)) && (!H || !H.test(n))) try {
                var r = O.call(t, n);
            ...
            var r = w.attrHandle[n.toLowerCase()],
                i = r && G.call(w.attrHandle, n.toLowerCase()) ? r(e, n, !L) : t;
            return i !== t ? i : C.attributes || !L ? e.getAttribute(n) : (i = e.getAttributeNode(n)) && i.specified ? i.value : null
        }, e.error = function(e) {
        ...
        return d.prototype = w.filters = w.pseudos, w.setFilters = new d, N = e.tokenize = function(t, n) {
            ...
            if (n = n || [], 1 === d.length) {
                if (o = d[0] = d[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && C.getById && 9 === t.nodeType && L && w.relative[o[1].type]) {
        ...
        function t(n) {
            ...
            function _(e, t, r) {
                ...
                o == i ? w(L[V], L[W], L[U], L[$]) > 0 && L.collapse(e) : L.collapse(e), L.collapsed = C(), L.commonAncestorContainer = n.findCommonAncestor(L[V], L[U])
            }
            ...
            function N(e) {
                ...
                for (o = x(L[V], L[W]), a = L[$] - L[W]; o && a > 0;) s = o.nextSibling, l = D(o, e), t && t.appendChild(l), --a, o = s;
        ...
        function i(i, a) {
            ...
            i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function(e) {
                ...
                var l = this,
                    c, u = 0,
                    d, f, h = [],
                    p, m, g, v, y, b, x, C, w, _, E, N, S, k, T, R, A, B, D, M, L, H, P, O, I, F = 0,
                    z = t.decode,
                    W, V = n.makeMap("src,href,data,background,formaction,poster"),
                    U = /((java|vb)script|mhtml):/i,
                    $ = /^data:/i;
                for (H = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-_\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), P = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, x = a.getShortEndedElements(), L = i.self_closing_elements || a.getSelfClosingElements(), C = a.getBoolAttrs(), _ = i.validate, b = i.remove_internals, W = i.fix_self_closing, O = a.getSpecialElements(); c = H.exec(e);) {
                    if (u < c.index && l.text(z(e.substr(u, c.index - u))), d = c[6]) d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), o(d);
                    else if (d = c[7]) {
                        if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), w = d in x, W && L[d] && h.length > 0 && h[h.length - 1].name === d && o(d), !_ || (E = a.getElementRule(d))) {
        ...
        return function(r, i) {
            ...
            function a(t) {
                var n, r, o, a, s;
                n = t.screenX - T, r = t.screenY - R, P = n * S[2] + D, O = r * S[3] + M, P = 5 > P ? 5 : P, O = 5 > O ? 5 : O, o = "IMG" == w.nodeName && i.settings.resize_img_proportional !== !1 ? !e.modifierPressed(t) : e.modifierPressed(t) || "IMG" == w.nodeName && S[2] * S[3] !== 0, o && (W(n) > W(r) ? (O = V(P * L), P = V(O / L)) : (P = V(O / L), O = V(P * L))), x.setStyles(_, {
                    width: P,
                    height: O
                    ...
                    top: s,
                    display: "block"
                }), E.innerHTML = P + " &times; " + O, S[2] < 0 && _.clientWidth <= P && x.setStyle(_, "left", A + (D - P)), S[3] < 0 && _.clientHeight <= O && x.setStyle(_, "top", B + (M - O)), n = U.scrollWidth - $, r = U.scrollHeight - q, n + r !== 0 && x.setStyles(E, {
                    left: a - n,
                    top: s - r
            ...
            function l(e, t, r) {
                ...
                g(), l = x.getPos(e, U), A = l.x, B = l.y, h = e.getBoundingClientRect(), u = h.width || h.right - h.left, d = h.height || h.bottom - h.top, w != e && (m(), w = e, P = O = 0), f = i.fire("ObjectSelected", {
                    ...
                    function o(t) {
                        T = t.screenX, R = t.screenY, D = w.clientWidth, M = w.clientHeight, L = M / D, S = e, e.startPos = {
                            x: u * e[0] + A,
                            y: d * e[1] + B
            ...
            var x = i.dom,
                C = t.each,
                w, _, E, N, S, k, T, R, A, B, D, M, L, H, P, O, I = i.getDoc(),
                F = document,
                z = n.ie && n.ie < 11,
                W = Math.abs,
                V = Math.round,
    ...
    }), r(H, [m, B, M, w, L, u, f], function(e, n, r, i, o, a, s) {
        function l(e, t, i, a) {
            var s = this;
    ...
    }), r(I, [m, w, L, P, f, O], function(e, t, n, r, i, o) {
        return function(a) {
            function s(e) {
                ...
                function f(e) {
                    ...
                    if (e = H(e, h, te), m.split) {
                        if (t = W(e, te), n = W(e), t != n) {
                            if (/^(TR|TH|TD)$/.test(t.nodeName) && t.firstChild && (t = "TR" == t.nodeName ? t.firstChild.firstChild || t : t.firstChild || t), r && /^T(HEAD|BODY|FOOT|R)$/.test(r.nodeName) && l(n) && n.firstChild && (n = n.firstChild || n), q.isChildOf(t, n) && !G(n) && !l(t) && !l(n)) return t = L(t, "span", {
                                id: "_start",
                                "data-mce-type": "bookmark"
                            }), c(t), void(t = d(te));
                            t = L(t, "span", {
            ...
            function I(e, t) {
                ...
                t.block && (X ? r == q.getRoot() && (t.list_block && R(e, t.list_block) || le(ce(e.childNodes), function(e) {
                    Y(X, e.nodeName.toLowerCase()) ? i ? i.appendChild(e) : (i = L(e, X), q.setAttribs(i, a.settings.forced_root_block_attrs)) : i = 0
            ...
            function o(o) {
                ...
                function g(t) {
                    ...
                    var i, o, l, c = t,
                        u;
                    if (t) {
                        if (n.ie && n.ie < 9 && D && D.firstChild && D.firstChild == D.lastChild && "BR" == D.firstChild.tagName && a.remove(D.firstChild), /^(LI|DT|DD)$/.test(t.nodeName)) {
                        ...
                        } else "BR" == t.nodeName ? t.nextSibling && a.isBlock(t.nextSibling) ? ((!M || 9 > M) && (u = a.create("br"), t.parentNode.insertBefore(u, t)), l.setStartBefore(t), l.setEndBefore(t)) : (l.setStartAfter(t), l.setEndAfter(t)) : (l.setStart(t, 0), l.setEnd(t, 0));
                ...
                function y(e) {
                    ...
                    if (e || "TABLE" == I ? (n = a.create(e || z), v(n)) : n = D.cloneNode(!1), o = n, l.keep_styles !== !1)
                        do
                            if (s[t.nodeName]) {
                ...
                function b(t) {
                    var n, r, i;
                    if (3 == A.nodeType && (t ? B > 0 : B < A.nodeValue.length)) return !1;
                    if (A.parentNode == D && W && !t) return !0;
                    if (t && 1 == A.nodeType && A == D.firstChild) return !0;
                    if ("TABLE" === A.nodeName || A.previousSibling && "TABLE" == A.previousSibling.nodeName) return W && !t || !W && t;
                    for (n = new e(A, D), 3 == A.nodeType && (t && 0 === B ? n.prev() : t || B != A.nodeValue.length || n.next()); r = n.current();) {
                        if (1 === r.nodeType) {
                ...
                function x(e, t) {
                    var n, r, o, s, l, c, d = z || "P";
                    if (r = a.getParent(e, a.isBlock), c = i.getBody().nodeName.toLowerCase(), !r || !h(r)) {
                        if (r = r || R, !r.hasChildNodes()) return n = a.create(d), v(n), r.appendChild(n), k.setStart(n, 0), k.setEnd(n, 0), n;
                ...
                function C() {
                    function e(e) {
                        for (var t = O[e ? "firstChild" : "lastChild"]; t && 1 != t.nodeType;) t = t[e ? "nextSibling" : "previousSibling"];
                        return t === D
                    }

                    function t() {
                        var e = O.parentNode;
                        return /^(LI|DT|DD)$/.test(e.nodeName) ? e : O
                    }
                    var n = O.parentNode.nodeName;
                    /^(OL|UL|LI)$/.test(n) && (z = "LI"), H = z ? y(z) : a.create("BR"), e(!0) && e() ? "LI" == n ? a.insertAfter(H, t()) : a.replace(H, O) : e(!0) ? "LI" == n ? (a.insertAfter(H, t()), H.appendChild(a.doc.createTextNode(" ")), H.appendChild(O)) : O.parentNode.insertBefore(H, O) : e() ? (a.insertAfter(H, t()), p(H)) : (O = t(), T = k.cloneRange(), T.setStartAfter(D), T.setEndAfter(O), P = T.extractContents(), "LI" == z && "LI" == P.firstChild.nodeName ? (H = P.firstChild, a.insertAfter(P, O)) : (a.insertAfter(P, O), a.insertAfter(H, O))), a.remove(D), g(H), c.add()
                }
                ...
                function S() {
                    H = /^(H[1-6]|PRE|FIGURE)$/.test(I) && "HGROUP" != F ? y(z) : y(), l.end_container_on_empty_block && h(O) && a.isEmpty(D) ? H = a.split(O, D) : a.insertAfter(H, D), g(H)
                }
                var k, T, R, A, B, D, M, L, H, P, O, I, F, z, W;
                if (k = s.getRng(!0), !o.isDefaultPrevented()) {
                    if (!k.collapsed) return void i.execCommand("Delete");
                    if (new t(a).normalize(k), A = k.startContainer, B = k.startOffset, z = (l.force_p_newlines ? "p" : "") || l.forced_root_block, z = z ? z.toUpperCase() : "", M = a.doc.documentMode, L = o.shiftKey, 1 == A.nodeType && A.hasChildNodes() && (W = B > A.childNodes.length - 1, A = A.childNodes[Math.min(B, A.childNodes.length - 1)] || A, B = W && 3 == A.nodeType ? A.nodeValue.length : 0), R = E(A)) {
                        if (c.beforeChange(), !a.isBlock(R) && R != a.getRoot()) return void((!z || L) && w());
                        if ((z && !L || !z && L) && (A = x(A, B)), D = a.getParent(A, a.isBlock), O = D ? a.getParent(D.parentNode, a.isBlock) : null, I = D ? D.nodeName.toUpperCase() : "", F = O ? O.nodeName.toUpperCase() : "", "LI" != F || o.ctrlKey || (D = O, I = F), /^(LI|DT|DD)$/.test(I)) {
                            if (!z && L) return void w();
                            if (a.isEmpty(D)) return void C()
                        }
                        if ("PRE" == I && l.br_in_pre !== !1) {
                            if (!L) return void w()
                        } else if (!z && !L && "LI" != I || z && L) return void w();
                        z && D === i.getBody() || (z = z || "P", b() ? S() : b(!0) ? (H = D.parentNode.insertBefore(y(), D), p(H), g(D)) : (T = k.cloneRange(), T.setEndAfter(D), P = T.extractContents(), _(P), H = P.firstChild, a.insertAfter(P, D), m(H), N(D), a.isEmpty(H) ? (a.remove(H), S()) : g(H)), a.setAttrib(H, "id", ""), i.fire("NewBlock", {
                            newBlock: H
                        }), c.add())
                    }
                }
        ...
        return function(r) {
            function v(e, t, n, i) {
                ...
                if (a = e.toLowerCase(), o = L.exec[a]) return o(a, t, n), r.fire("ExecCommand", {
                    command: e,
                    ui: t,
                    value: n
                }), !0;
            ...
            function C(e, t, n) {
                e = e.toLowerCase(), L.exec[e] = function(e, i, o, a) {
            ...
            r.on("PreInit", function() {
                B = r.dom, D = r.selection, H = r.settings, M = r.formatter
            }), l(this, {
                execCommand: v,
                queryCommandState: y,
                queryCommandValue: b,
                ...
                "Indent,Outdent": function(e) {
                    var t, n, i;
                    t = H.indentation, n = /[a-z%]+$/i.exec(t), t = parseInt(t, 10), y("InsertUnorderedList") || y("InsertOrderedList") ? S(e) : (H.forced_root_block || B.getParent(D.getNode(), B.isBlock) || M.apply("div"), s(D.getSelectedBlocks(), function(o) {
                        if ("LI" != o.nodeName) {
            ...
            v = {
                ...
                repaint: function() {
                    ...
                    c = document.createRange ? function(e) {
                        ...
                        e._hasBody && i.innerH !== l.innerH && (u = c(i.innerH), r = r || e.getEl("body"), r && (n = n || r.style, n.height = (u >= 0 ? u : 0) + "px"), l.innerH = i.innerH), e._lastRepaintRect = l, e.fire("repaint", {}, !1)
                },
                on: function(e, t) {
                    function n(e) {
                        var t, n;
        ...
        return function(s) {
            ...
            function d(e) {
                var t, n;
                e.dataTransfer && (s.selection.isCollapsed() && "IMG" == e.target.tagName && J.select(e.target), t = s.selection.getContent(), t.length > 0 && (n = ie + escape(s.id) + "," + escape(t), e.dataTransfer.setData(oe, n)))
            }
            ...
            var j = a.each,
                ...
                oe = ne ? "Text" : "URL";
            S(), m(), H(), re && (p(), v(), x(), R(), U(), _(), $(), o.iOS ? (O(), I(), V()) : g()), ne && o.ie < 11 && (y(), w(), E(), N(), B(), D(), M(), L()), o.ie >= 11 && (I(), W(), _()), o.ie && (g(), z(), q()), te && (y(), b(), C(), k(), T(), A(), P(), F(), _())
        }
        ...
        return function(i) {
            ...
            function l(n) {
                return h || (h = new t({
                    ...
                    return r = e.map(t, function(e) {
                        return e.blobInfo
                    }), h.upload(r).then(function(r) {
                        return r = e.map(r, function(e, n) {
                            var r = t[n].image;
                            return s(r.src, e.url), i.$(r).attr({
                                src: e.url,
            ...
            function c() {
                return p || (p = new n(f)), p.findAll(i.getBody()).then(function(t) {
            ...
            function d(t) {
                return t.replace(/src="(blob:[^"]+)"/g, function(t, n) {
                    ...
                    }, null)), r ? 'src="data:' + r.blob().type + ";base64," + r.base64() + '"' : t[0]
                })
            }
            var f = new r,
                h, p;
    ...
    }), r(Ee, [b, h, C, _, E, A, R, H, I, F, z, W, V, U, x, l, he, N, k, pe, u, f, me, ge, _e], function(e, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v, y, b, x, C, w, _, E, N) {
        function S(e, t, i) {
            var o = this,
                a, s;
        ...
        return S.prototype = {
            ...
            init: function() {
                function e(n) {
                    var r = R.get(n),
                        i, o;
                    i = R.urls[n] || t.documentBaseUrl.replace(/\/$/, ""), n = L(n), r && -1 === M(m, n) && (B(R.dependencies(n), function(t) {
                        e(t)
            ...
            getParam: function(e, t, n) {
                ...
                return "hash" === n ? (i = {}, "string" == typeof r ? B(r.indexOf("=") > 0 ? r.split(/[;,](?![^=;,]*(?:[;,]|$))/) : r.split(","), function(e) {
                    e = e.split("="),
                        e.length > 1 ? i[L(e[0])] = L(e[1]) : i[L(e[0])] = L(e)
                }) : i = r, i) : r
            },
    ...
    }), r(ke, [Ee, h, b, U, u, f, K, Ne, Se], function(e, t, n, r, i, o, a, s, l) {
        function c(e) {
    ...
    }), r(Le, [b, l, x, C, f, u], function(e, t, n, r, i, o) {
        ...
        return e.extend({
            recalc: function(e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v = [],
                    y, b, x, C, w, _, E, N, S, k, T, R, A, B, D, M, L, H, P, O, I, F, z = Math.max,
                    W = Math.min;
    ...
    }), r(rt, [te, Ie, ue, f, ke, u], function(e, t, n, r, i, o) {
        function a(e) {
            function t(t, n) {
                return function() {
                    var r = this;
    ...
    }), a([l, c, u, f, h, p, m, v, b, x, C, w, E, N, S, k, T, R, A, D, M, L, H, I, F, V, U, $, q, K, G, X, ee, te, ne, re, ie, oe, ae, se, le, ce, ue, de, fe, he, me, ge, ve, Ee, Ne, Se, ke, Re, Ae, Be, De, Me, Le, He, Pe, Oe, Ie, Fe, ze, We, Ve, Ue, $e, qe, je, Ke, Ye, Ge, Xe, Je, Qe, Ze, et, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, ht, pt, mt, gt, vt, yt, bt, xt, Ct, wt])
}(this);