...
urlpatterns = [
    ...
    url(r'^news_listing.htm$', NewsList.as_view()),
    ...
    url(r'^teams_listing.htm$', TeamsList.as_view()),
    url(r'^matches.htm$', MatchList.as_view()),
    ...
    url(r'^gallery.htm',ImageListview.as_view()),
